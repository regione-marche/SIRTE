...
public class AttivitaPrestGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	
	private String myKeyPermission = AttivitaPrestFormCtrl.myKeyPermission;
	private SocAssAttPrestEJB myEJB = new SocAssAttPrestEJB();
	private String myPathFormZul = "/web/ui/common/attivita_prest/attivitaPrestForm.zul";
