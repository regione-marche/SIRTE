...
public class ValutatoriFormCtrl extends CaribelFormCtrl {
		...
		public static String myKeyPermission = "TABPRVAL";
		...
		public void doInitForm() {
			try {
				...
				if(dbrFromList!=null){
					hParameters.put("tv_codice", ""+dbrFromList.get("tv_codice"));
					doQueryKeySuEJB();
