...
public class RsaMotDimGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	
	private String myKeyPermission = RsaMotDimFormCtrl.myKeyPermission;
	private RsaMotiEJB myEJB = new RsaMotiEJB();
	private String myPathFormZul = "/web/ui/common/rsa_motDim/rsaMotDimForm.zul";
