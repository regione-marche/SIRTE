...
import it.caribel.app.common.controllers.fig_prof.FigProfFormCtrl;
...
public class GradoParentGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	
	private String myKeyPermission = GradoParentFormCtrl.myKeyPermission;
	private ParentEJB myEJB = new ParentEJB();
	private String myPathFormZul = "/web/ui/common/grado_parent/gradoParentForm.zul";
