...
public class SoctabGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	
	private String myKeyPermission = SoctabFormCtrl.myKeyPermission;
	private SSoctabEJB myEJB = new SSoctabEJB();
	private String myPathFormZul = "/web/ui/common/soctab/soctabForm.zul";
