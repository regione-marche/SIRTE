...
public class PensioniGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	
	private String myKeyPermission = PensioniFormCtrl.myKeyPermission;
	private PensioniEJB myEJB = new PensioniEJB();
	private String myPathFormZul = "/web/ui/common/pensioni/pensioniForm.zul";
