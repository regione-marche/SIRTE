...
public class StatoProfGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	
	private String myKeyPermission = StatoProfFormCtrl.myKeyPermission;
	private PosproEJB myEJB = new PosproEJB();
	private String myPathFormZul = "/web/ui/common/statoProf/statoProfForm.zul";
