...
// --------------------------------------------------------------------------
//
// 08/05/2000 - EJB di connessione alla procedura SINS Tabella Pospro
//
// paolo ciampolini
//
// ==========================================================================
...
public class PosproEJB extends SINSSNTConnectionEJB  {
...
public ISASRecord queryKey(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		...
		String myselect="Select * from pospro where "+
...
public Vector query(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		String myselect="Select * from pospro";
      ...
      //controllo valore corretto descrizione
        ...
        System.out.println("query GridPospro: "+myselect);
...
throws DBRecordChangedException, ISASPermissionDeniedException, SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		ISASRecord dbr=dbc.newRecord("pospro");
