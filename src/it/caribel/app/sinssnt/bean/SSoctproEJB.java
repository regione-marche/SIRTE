...
// --------------------------------------------------------------------------
//
// 16/03/2004 - EJB di connessione alla procedura SINS Tabella SSoctpro
//
// Giulia Brogi
//
// ==========================================================================
...
public class SSoctproEJB extends SINSSNTConnectionEJB  {

public SSoctproEJB() {}
private static final String MIONOME = "2-SSoctproEJB.";
...
public ISASRecord queryKey(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		...
		String myselect="SELECT * from ssoctpro where "+
...
public Vector query(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		String query="Select * from ssoctpro ";
		String myselect = "";
...
throws DBRecordChangedException, ISASPermissionDeniedException, SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		ISASRecord dbr=dbc.newRecord("ssoctpro");
		...
		dbc.writeRecord(dbr);
		String myselect="Select * from ssoctpro where codice='"+codice+"'";
