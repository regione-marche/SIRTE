...
// --------------------------------------------------------------------------
//
// 15/05/2000 - EJB di connessione alla procedura SINS Tabella Resparg
//
// ==========================================================================
...
public class RespargEJB extends SINSSNTConnectionEJB  {
...
public ISASRecord queryKey(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		...
		String myselect="Select * from resparg where "+
...
public Vector query(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		String myselect="Select * from resparg";
      ...
      //controllo valore corretto descrizione
        ...
        System.out.println("query GridResparg: "+myselect);
...
throws DBRecordChangedException, ISASPermissionDeniedException, SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		ISASRecord dbr=dbc.newRecord("resparg");
