...
// --------------------------------------------------------------------------
// 10/02/2003
// EJB di connessione alla tabella medspec
// Sara Cossu
// ==========================================================================
...
public class MedspecEJB extends SINSSNTConnectionEJB  {
public MedspecEJB() {}
public ISASRecord queryKey(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		...
		String myselect="Select * from medspec where "+
...
public Vector query(myLogin mylogin,Hashtable h) throws  SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		String myselect="Select * from medspec";
...
// m. 12/01/04 myselect=myselect+" where descrizione like '"+scr+"%'";
			myselect = myselect + " where UPPER(descrizione)" +
						" like UPPER('" + scr + "%')";
        }
		myselect=myselect+" ORDER BY descrizione ";
        System.out.println("query GridMedspec: "+myselect);
...
// m. 12/01/04 myselect=myselect+" where descrizione like '"+scr+"%'";
		...
		myselect=myselect+" ORDER BY codice ";
        System.out.println("query GridMedspec: "+myselect);
		ISASCursor dbcur=dbc.startCursor(myselect);
		//Vector vdbr=dbcur.getAllRecord();
...
throws DBRecordChangedException, ISASPermissionDeniedException, SQLException {
	...
	try{
		dbc=super.logIn(mylogin);
		ISASRecord dbr=dbc.newRecord("medspec");
