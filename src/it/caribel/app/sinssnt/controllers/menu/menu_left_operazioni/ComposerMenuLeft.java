package it.caribel.app.sinssnt.controllers.menu.menu_left_operazioni;

import it.caribel.app.sinssnt.controllers.menu.menu_left_operazioni.data.ListaMenu;
...
public class ComposerMenuLeft extends MenuComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		initTree(menu_tree_operazioni, new AdvancedTreeModel(new ListaMenu().getRoot()));
	}
