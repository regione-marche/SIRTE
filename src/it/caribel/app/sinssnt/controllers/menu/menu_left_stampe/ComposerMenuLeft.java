package it.caribel.app.sinssnt.controllers.menu.menu_left_stampe;

import it.caribel.app.sinssnt.controllers.menu.menu_left_stampe.data.ListaMenu;
...
public class ComposerMenuLeft extends MenuComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		initTree(menu_tree_stampe, new AdvancedTreeModel(new ListaMenu().getRoot()));
	}
