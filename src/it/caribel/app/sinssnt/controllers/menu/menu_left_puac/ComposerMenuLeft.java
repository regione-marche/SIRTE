package it.caribel.app.sinssnt.controllers.menu.menu_left_puac;

import it.caribel.app.sinssnt.controllers.menu.menu_left_puac.data.ListaMenu;
...
public class ComposerMenuLeft extends MenuComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		initTree(menu_tree_puac, new AdvancedTreeModel(new ListaMenu().getRoot()));
	}
