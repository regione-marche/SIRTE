package it.caribel.app.sinssnt.controllers.menu.menu_left_agenda;

import it.caribel.app.sinssnt.controllers.menu.menu_left_agenda.data.ListaMenu;
...
public class ComposerMenuLeft extends MenuComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		initTree(menu_tree_agenda, new AdvancedTreeModel(new ListaMenu().getRoot()));
	}
