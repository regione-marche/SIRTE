...
public class TestComposer extends Calendar {
                private static final long serialVersionUID = 7513083343273393743L;
                private List<Date> _selectedDates;
                static {
                                addClientEvent(TestComposer.class, "onCustomSelect", CE_IMPORTANT|CE_REPEAT_IGNORE|CE_NON_DEFERRABLE);
                }
                ...
                public void onMySelect(ForwardEvent event){
                    _selectedDates = new ArrayList<Date>();
                    java.util.Calendar cal = java.util.Calendar.getInstance();
                    // current selected date
                    cal.setTime(getValue());
