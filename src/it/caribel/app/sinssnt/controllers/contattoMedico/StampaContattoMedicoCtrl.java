...
public class StampaContattoMedicoCtrl extends CaribelFormCtrl {
	private static final long serialVersionUID = 1L;
	
	public static String CTS_FILE_ZUL = "/web/ui/sinssnt/contatto_medico/stampa_contatto_medico.zul";
	...
	public void doStampa() {
		try {
			String metodo = "query_skmed";
			String report="medici.fo";
	...
	private String caricaPagine()
	{
		String idCorr = "";
		String ret = "";
		Collection<Treeitem> figli = tree_stampa_medico.getTreechildren().getItems();
