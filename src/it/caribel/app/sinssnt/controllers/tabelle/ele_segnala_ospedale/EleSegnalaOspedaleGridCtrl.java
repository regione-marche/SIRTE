...
public class EleSegnalaOspedaleGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	private Hashtable<String, Object> parkSetting;
	private String myKeyPermission = "SEGN_O";
	private DimissOspEJB myEJB = new DimissOspEJB();
	private String myPathFormZul = "/web/ui/sinssnt/tabelle/ele_segnala_ospedale/eleSegnalaOspedaleForm.zul";
	
	
	protected CaribelTextbox tb_filter1;
	protected CaribelTextbox tb_filter2;	
