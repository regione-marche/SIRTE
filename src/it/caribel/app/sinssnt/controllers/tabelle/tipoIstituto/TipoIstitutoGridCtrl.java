...
public class TipoIstitutoGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	private Hashtable<String, Object> parkSetting;
	private String myKeyPermission = "TIPO_IST";
	private RsaTipoIstitutoSts11EJB myEJB = new RsaTipoIstitutoSts11EJB();
	private String myPathFormZul = "/web/ui/sinssnt/tabelle/tipoIstituto/tipoIstitutoForm.zul";
...
public void caricaComboOrganizzazione() {
	try {
		...
		CaribelTextbox campo_codice = new CaribelTextbox();
		Hashtable<String, Object> h = new Hashtable();
		Hashtable h1 = new Hashtable(); // x le comboBox da caricare		
		h1.put( campo_codice,"far_cod");
		
		CaribelComboRepository.comboPreLoad("ORGMOD1", new RsaTipoIstitutoSts11EJB(), "query_combo_org", h1, tb_filter2,null, "codice", "descrizione", false);
	}catch(Exception e){
		doShowException(e);
	}
...
public void caricaComboIstituti() {
	try {
		...
		CaribelComboRepository.comboPreLoad("TIPOIST1", new RsaTipoIstitutoSts11EJB(), "query_combo_ist", h1, tb_filter1,null, "codice", "descrizione", false);
