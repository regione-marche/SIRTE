...
public class ContattoGenGridCtrl extends CaribelGridCtrl {

	private static final long serialVersionUID = 1L;
	
	private String myKeyPermission = ChiaviISASSinssntWeb.CONTATTO_GENERICO_STORICO;
	...
	public void doAfterCompose(Component comp) throws Exception {
		super.initCaribelGridCtrl(myEJB, myKeyPermission, ContattoGenFormCtrl.CTS_FILE_ZUL);
	 ...
	 //           JCariTable1.setColumnHidden("Data chiusura");
			this.hParameters.put("skfpg_tipo_operatore", getProfile().getStringFromProfile(ManagerProfile.TIPO_OPERATORE));
			doRefresh();
		}
    }
