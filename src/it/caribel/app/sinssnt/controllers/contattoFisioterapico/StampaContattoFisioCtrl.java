...
public class StampaContattoFisioCtrl extends CaribelFormCtrl {
	private static final long serialVersionUID = 1L;
	
	public static String CTS_FILE_ZUL = "/web/ui/sinssnt/contatto_fisioterapico/stampa_contatto_fisio.zul";
	...
	public void doStampa() {
		try {
			String metodo = "query_skfisio";
			String report="fisioterapisti.fo";
	...
	private String caricaPagine()
	 {
	  String idCorr = "";
	  String ret = "";
	  Collection<Treeitem> figli = tree_stampa_fisio.getTreechildren().getItems();
