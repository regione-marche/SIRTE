...
public class ReportEleContattiApertiCtrl extends CaribelFormCtrl {
	...
	public void doStampa() {
		try {
             ...
             String report = (formato.equals("1")?"eleContattiAperti.fo":"eleContattiAperti.html");

             String con_piano = pres_piano.getSelectedItem().getValue();
             String comple_ass="";
