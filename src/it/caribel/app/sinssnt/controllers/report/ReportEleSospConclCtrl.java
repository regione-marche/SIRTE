...
public class ReportEleSospConclCtrl extends CaribelFormCtrl {
	private static final long serialVersionUID = 1L;
	
	protected CaribelRadiogroup formatoStampa;
	protected CaribelRadiogroup tipologia;
	
	
	protected Radio pdf;
	protected Radio html;
	protected Radio sosp;
	protected Radio concl;
	...
	public void doStampa() {
		try {
            ...
            String report = (formato.equals("1")?"elencoSospConc.fo":"elencoSospConc.html");

            String tipo_piano = tipologia.getSelectedItem().getValue();
            String comple_ass="";
            if (!compl_ass.getValue().equals(""))
           	 comple_ass = compl_ass.getSelectedItem().getValue();
            ...
            String zone = zona.getSelectedItem().getValue();
 	        ...
 	        String terr="";
                 ...
                 String servlet = "/SINSSNTFoServlet/SINSSNTFoServlet"+
	    				 	 "?EJB=SINS_FOELESOSPCONC"+                		 
                             "&METHOD=query_report" +
                             "&TYPE=" + tpFormato+"&d1="+d1+"&d2=" + d2
                             + "&tipo=" + tipo_piano
                             + "&compl_ass=" + comple_ass
                             + "&zona=" + zone + "&distretto=" + distr + "&pca=" + pca
                             +"&REPORT=" + report + "&terr=" + terr +
