...
public class ReportStatPrestNoDomCtrl extends CaribelFormCtrl {
	...
	public void doStampa() {
		try {
		    ...
		    String servlet="/SINSSNTFoServlet/SINSSNTFoServlet"+
		    		...
		    		"&METHOD=query_prest_nodom&data_inizio="+
		            data_inizio+"&ragg="+ragg+"&pca="+pca+"&distretto="+distr+"&dom_res="+tipo_ubi+"&socsan="+socsan+
		            "&zona="+zone+"&data_fine="+data_fine+"&REPORT="+report+ "&TYPE=" + TYPE+"&tipo=AMB";
