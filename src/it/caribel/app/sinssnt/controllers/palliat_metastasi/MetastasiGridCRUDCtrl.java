package it.caribel.app.sinssnt.controllers.palliat_metastasi;

import it.caribel.app.sinssnt.bean.modificati.SkMPalMetEJB;
...
public class MetastasiGridCRUDCtrl extends CaribelGridCRUDCtrl {

	private static final long serialVersionUID = 1L;
	//public static String myKeyPermission = ChiaviIsasBase.INTOLLERANZA_ALLERGIA;
	public static String myKeyPermission = "";
	private SkMPalMetEJB myEJB = null;	
	public static final String myPathFormZul ="/web/ui/sinssnt/contatto_palliativista/metastasiForm.zul";
